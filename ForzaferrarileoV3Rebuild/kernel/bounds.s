...
@ include/generated/autoconf.h -MD kernel/.bounds.s.d kernel/bounds.c
@ -mlittle-endian -marm -mabi=aapcs-linux -mno-thumb-interwork
@ -march=armv7-a -msoft-float -mfpu=neon -auxbase-strip kernel/bounds.s -g
@ -Os -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs
@ -Werror-implicit-function-declaration -Wno-format-security
@ -Wuninitialized -Wframe-larger-than=1024 -Wdeclaration-after-statement
...
@ -fconserve-stack -fgcse-lm -fgcse-sm -fsched-spec-load -fforce-addr
@ -ffast-math -fsingle-precision-constant -ftree-vectorize -funroll-loops
@ -fverbose-asm
